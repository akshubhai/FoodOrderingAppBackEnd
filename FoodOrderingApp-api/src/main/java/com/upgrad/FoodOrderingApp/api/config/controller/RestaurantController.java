package com.upgrad.FoodOrderingApp.api.controllers;
...
public class RestaurantController {
    ...
    */
    ...
    public ResponseEntity<RestaurantListResponse> getAllRestaurants() {
        ...
        List<com.upgrad.FoodOrderingApp.service.Entity.RestaurantEntity> listOfRestaurants = restaurantService.restaurantsByRating();
        ...
        for (com.upgrad.FoodOrderingApp.service.Entity.RestaurantEntity restaurantEntity : listOfRestaurants) { //Looping for each restaurant entity in restaurantEntities
            ...
            List<com.upgrad.FoodOrderingApp.service.Entity.CategoryEntity> categoryEntityList = categoryService.getCategoriesByRestaurant(restaurantEntity.getUuid());
            List<String> stringCategories = new ArrayList<>();
            for (com.upgrad.FoodOrderingApp.service.Entity.CategoryEntity category : categoryEntityList) {
    ...
    */
    ...
    public ResponseEntity<RestaurantDetailsResponse> getRestaurantByRestaurantID(
        ...
        com.upgrad.FoodOrderingApp.service.Entity.RestaurantEntity restaurantEntity = restaurantService.restaurantByUUID(restaurantUuid);

        //Calls  getCategoriesByRestaurant to get categories of the corresponding restaurant.
        List<com.upgrad.FoodOrderingApp.service.Entity.CategoryEntity> categoryEntities = categoryService.getCategoriesByRestaurant(restaurantUuid);

        List<CategoryList> categoryLists = new LinkedList<>();
        for (com.upgrad.FoodOrderingApp.service.Entity.CategoryEntity categoryEntity : categoryEntities) {

            List<com.upgrad.FoodOrderingApp.service.Entity.ItemEntity> itemEntities = itemService.getItemsByCategoryAndRestaurant(restaurantUuid, categoryEntity.getUuid());
    ...
    public ResponseEntity<RestaurantUpdatedResponse> updateRestaurantDetails(@RequestParam(name = "customer_rating") Double customerRating,
        ...
        com.upgrad.FoodOrderingApp.service.Entity.RestaurantEntity restaurantEntity = restaurantService.restaurantByUUID(restaurant_id);
    ...
    */
    ...
    public ResponseEntity<RestaurantListResponse> getAllRestaurantByName(@PathVariable("reastaurant_name") final String restaurantName) throws RestaurantNotFoundException {
        ...
        List<com.upgrad.FoodOrderingApp.service.Entity.RestaurantEntity> restaurantEntities = restaurantService.restaurantsByName(restaurantName);
        if (!restaurantEntities.isEmpty()) {
            List<RestaurantList> restaurantLists = new LinkedList<>();
            for (com.upgrad.FoodOrderingApp.service.Entity.RestaurantEntity restaurantEntity : restaurantEntities) {
                List<com.upgrad.FoodOrderingApp.service.Entity.CategoryEntity> categoryEntities = categoryService.getCategoriesByRestaurant(restaurantEntity.getUuid());
                String categories = new String();
                ListIterator<com.upgrad.FoodOrderingApp.service.Entity.CategoryEntity> listIterator = categoryEntities.listIterator();
    ...
    */
    ...
    public ResponseEntity<RestaurantListResponse> getRestaurantByCategoryId(
        ...
        List<com.upgrad.FoodOrderingApp.service.Entity.RestaurantEntity> listOfCategoryRestaurants = restaurantService.restaurantByCategory(categoryId);

        List<RestaurantList> restaurantList = new ArrayList<RestaurantList>();

        RestaurantListResponse restaurantListResponse = new RestaurantListResponse();

        for (com.upgrad.FoodOrderingApp.service.Entity.RestaurantEntity restaurantEntity : listOfCategoryRestaurants) {
            RestaurantList restaurantDetails = new RestaurantList();
            restaurantDetails.setId(UUID.fromString(restaurantEntity.getUuid()));
            restaurantDetails.setRestaurantName(restaurantEntity.getRestaurantName());
            restaurantDetails.setPhotoURL(restaurantEntity.getPhotoUrl());
            ...
            List<com.upgrad.FoodOrderingApp.service.Entity.CategoryEntity> restaurantCategories = categoryService.getCategoriesByRestaurant(restaurantEntity.getUuid());
            List<String> stringCategories = new ArrayList<>();
            for (com.upgrad.FoodOrderingApp.service.Entity.CategoryEntity c : restaurantCategories) {
