...
public class OrderController {
   ...
   */
    ...
    public ResponseEntity<CouponDetailsResponse> getCouponByCouponName(@RequestHeader("authorization") final String authorization,
        ...
        com.upgrad.FoodOrderingApp.service.Entity.CustomerEntity customerEntity = customerService.getCustomer(userAccessToken);

        //Calls getCouponByCouponName of orderService to get the coupon by name from DB
        com.upgrad.FoodOrderingApp.service.Entity.CouponEntity couponEntity =  orderService.getCouponByCouponName(couponName);
    ...
    */
    ...
    public ResponseEntity<CustomerOrderResponse> getPastOrdersOfUser(@RequestHeader("authorization") final String authorization) throws AuthenticationFailedException, AuthorizationFailedException {
        ...
        List<com.upgrad.FoodOrderingApp.service.Entity.OrderEntity> ordersEntities = orderService.getOrdersByCustomers(customerEntity.getUuid());
        ...
        if (ordersEntities != null) { //Checking if orderentities is null if yes them empty list is returned
            for (com.upgrad.FoodOrderingApp.service.Entity.OrderEntity orderEntity : ordersEntities) { //looping in for every orderentity in orderentities

                //Calls getOrderItemsByOrder by order of orderService get all the items ordered in past by orders.
                List<com.upgrad.FoodOrderingApp.service.Entity.OrderItemEntity> orderItemEntities = orderService.getOrderItemsByOrder(orderEntity);
            ...
            PaymentMethodNotFoundException, RestaurantNotFoundException, ItemNotFoundException
    {
        ...
        com.upgrad.FoodOrderingApp.service.Entity.OrderEntity orderEntity = new com.upgrad.FoodOrderingApp.service.Entity.OrderEntity();
        ...
        if(couponUuid!=null) {
            com.upgrad.FoodOrderingApp.service.Entity.CouponEntity couponEntity = orderService.getCouponByCouponId(couponUuid);
        ...
        if(paymentUuid!=null) {
            com.upgrad.FoodOrderingApp.service.Entity.PaymentEntity paymentEntity = paymentService.getPaymentByUUID(paymentUuid);
        ...
        com.upgrad.FoodOrderingApp.service.Entity.AddressEntity addressEntity = addressService.getAddressByUUID(addressUuid, customerEntity);
        ...
        List<com.upgrad.FoodOrderingApp.service.Entity.OrderItemEntity> orderItemEntityList = new ArrayList<>();

        com.upgrad.FoodOrderingApp.service.Entity.OrderEntity savedOrderEntity = orderService.saveOrder(orderEntity);

        for(ItemQuantity itemQuantity: itemList) {
            com.upgrad.FoodOrderingApp.service.Entity.OrderItemEntity orderedItem = new com.upgrad.FoodOrderingApp.service.Entity.OrderItemEntity();
            com.upgrad.FoodOrderingApp.service.Entity.ItemEntity itemEntity = itemService.getItemByUuid(itemQuantity.getItemId().toString());
